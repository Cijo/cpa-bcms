 ...
 * @enum {string}
 */
export declare type Granularity = 'yearly' | 'monthly' | 'weekly' | 'daily' | 'hourly' | 'minutely' | 'secondly';
/**
 * Contains response data for the entireDetect operation.
 */
export declare type EntireDetectResponse2 = EntireDetectResponse & {
    /**
 ...
 */
export declare type LastDetectResponse2 = LastDetectResponse & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type ChangePointDetectResponse2 = ChangePointDetectResponse & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
